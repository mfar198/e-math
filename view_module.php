			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-8">
							<dl>
								<dt><b class="border-bottom border-primary">Module Name</b></dt>
								...
								"<iframe width=\"600\" height=\"315\" src=\"//www.youtube.com/embed/$2\" allowfullscreen></iframe>",
								$string
								);
								}
						...
						<div class="col-md-4">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Teacher</b></dt>
								<dd>
									...
									<?php else: ?>
										<small><i>Teacher Deleted from Database</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
					...
					?>
						<div class="post">
		                      ...
		                      <div class="user-block">
		                      	<?php if($_SESSION['login_id'] == $row['user_id'] or $_SESSION['login_type'] != 2) : ?>
							...
							<div>
							<?php
							if(empty(ucwords($row['submission']))){
							
	
							}else{ ?>
							<?php echo ucwords($row['submission']) ?>
							<a class="btn btn-primary btn-sm" href="downloadsubs.php?file_id=<?php echo ucwords($row['submission'])?>">Download</a>
							<?php }
							?>
							</div>
		                      <p>
