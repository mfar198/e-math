...
Class Action {
	...
	function delete_project(){
		extract($_POST);
		$delete = $this->db->query("DELETE FROM task_list where project_id = $id");
		$delete = $this->db->query("DELETE FROM user_productivity where project_id = $id");
