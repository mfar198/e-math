      ...
      <?php endif; ?>
		...
		<div class="row">
			<div class="col-md-10">
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="video" placeholder="Example: www.youtube.com" value="<?php echo isset($video) ? $video : '' ?>">
				</div>
			</div>
		</div>
		<div class="row">
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			...
    			<button class="btn btn-flat bg-gradient-secondary mx-2" type="button" onclick="location.href='index.php?page=module_list'">Cancel</button>
    		</div>
    	</div>
	</div>
</div>
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.href = 'index.php?page=module_list'
					},2000)
				}
			}
		})
