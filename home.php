                  ...
                  <tr>
                      ...
                      <td class="project_progress">
                          <div class="progress progress-sm">
                              <div class="progress-bar bg-green" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $prog ?>%">
                              </div>
                          </div>
                          <small>
                      ...
                      <td>
                        <a class="btn btn-primary btn-sm" href="./index.php?page=view_module&id=<?php echo $row['id'] ?>">
